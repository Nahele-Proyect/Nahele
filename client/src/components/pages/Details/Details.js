...
export default class Details extends Component {
  ...
  componentDidMount = () => {
    this.props.match.params.link &&
      this.getOnePet(this.props.match.params.link);
        ...
        {this.state.pet ? (
          <>
            <div className="details">
              <Container>
                <Row className="justify-content-between align-items-center">
                  <Col md={5}>
                    <figure>
                      <img src={this.state.pet.img} alt="pet" />
                    </figure>
                    {this.props.loggedInUser && (
                      <Button
                        size="lg"
                        variant="outline-info"
                        onClick={this.showAdoptModal}
                      >
                        Adoptar
                      </Button>
                    )}
                  ...
                  <Col md={5}>
                    ...
                    <p>
                      Nacimiento:{" "}
                      {this.state.pet.born
                        ? this.state.pet.born.substr(0, 10)
                        : "Desconocido"}
                    </p>
              ...
              {this.props.loggedInUser && (
                <Link
                  ...
                  to={`/newCalendar/${this.props.match.params.link}`}
                >
                  <h3>CALENDARIO</h3>
                </Link>
              )}
            ...
            <Modal
              size="sm"
              centered
              show={this.state.showAdoptModal}
